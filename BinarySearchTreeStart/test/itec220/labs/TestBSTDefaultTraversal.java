...
class TestBSTDefaultTraversal {
	...
	@Test
	void testLevelorderValues() {
		//Arrange 
		ArrayList<Integer> preOrderNumberList = new ArrayList<Integer>(Arrays.asList(50, 25, 75, 15, 35, 65, 85, 5, 20, 30, 45, 60, 70, 80, 95 ) );
		// Act
		ArrayList<Integer> preOrderActual = defaultNumberTree.values(BinarySearchTree.Traversal.LEVEL_ORDER);
		// Assert
		assertEquals(preOrderNumberList, preOrderActual);
	...
	void testNull() {
		//Arrange 
		ArrayList<Integer> inorderNumberList = null;
		// Act
		ArrayList<Integer> inorderActual = defaultNumberTree.values(null);
		// Assert
		assertEquals(inorderNumberList, inorderActual);
